...
import OpportunityNoteModal from "@/Components/Tenant/Operations/Opportunities/OpportunityNoteModal";
 ...
 */
export default function OpportunityStageStepsComponent({
    steps = [],
    currentIndex = "",
    onStepClick = () => {},
    showStepHeader = true,
    ...
    const [OpportunityNoteModalOpen, setOpportunityNoteModalOpen] =
        useState(false);
    ...
    const handleTooltipChoice = (choice, stepKey) => {
        ...
        if (isThisFinalStep) {
            ...
            setModalTitle("Write opportunity won notes");
    ...
    const lost = stepEntries.find(([, v]) => v.label.toLowerCase() === "lost");
    const normalSteps = stepEntries.filter(
        ([, v]) => v.label.toLowerCase() !== "lost"
    );
    ...
    const openLostModal = () => {
        setModalTitle("Write opportunity lost notes");
        ...
        <div className="w-full mb-3">
            ...
            >
                <p className="text-sm text-gray-600">
                    {__("Are you sure you want to disqualify this opportunity")}
                </p>
            </ModalBasic> */}

            {/* Opportunity Create Modal */}
            {OpportunityNoteModalOpen && (
                <OpportunityNoteModal
                    isModalOpen={OpportunityNoteModalOpen}
                    setIsModalOpen={setOpportunityNoteModalOpen}
                    finalStepInfos={{
                        stageable_id: opportunityId,
