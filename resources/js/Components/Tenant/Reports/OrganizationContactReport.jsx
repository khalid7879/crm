...
export default function OrganizationContactReport({ dataItems, addLinkBtn = false }) {
    ...
    return (
        <>
            <FormSectionComponent
                ...
                iconTitle="Add new organization contact"
                        ...
                        <TableBodyComponent>
                            {dataItems.map((item, index) => (
                                <TableTrComponent key={`row_${index}`}>
                                    ...
                                    <TableCell data={item.organization_name} />
