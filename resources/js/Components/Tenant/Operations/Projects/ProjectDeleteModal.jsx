 ...
 */
export default function ProjectDeleteModal({ isModalOpen, setIsModalOpen, currentActionId }) {
    ...
    /**
     * Precompute the route to delete the projects.
     * @type {string | null}
     */
    const deleteRoute = useMemo(
        () =>
            currentActionId
                ? route(routeNames.projectsDelete, {
                      project: currentActionId,
                      tenant,
                  })
                : null,
    ...
    /**
     * Fetch projects details from the backend when the modal opens.
    ...
    return (
        <ModalFormInputsLayout
            title={__("Delete project text")}
            isModalOpen={isModalOpen}
            setIsModalOpen={setIsModalOpen}
            size="md"
            processing={processing}
            headerIcon="delete"
            saveText={__("Yes delete the project text")}
