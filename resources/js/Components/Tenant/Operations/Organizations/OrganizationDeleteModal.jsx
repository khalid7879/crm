...
export default function OrganizationDeleteModal({
    ...
    /**
     * Precompute the route to delete the organization.
     * @type {string | null}
     */
    const deleteRoute = useMemo(
        () =>
            currentActionId
                ? route(routeNames.organizationDelete, {
                      organization: currentActionId,
                      tenant,
                  })
                : null,
    ...
    /**
     * Fetch organization details from the backend when the modal opens.
    ...
    return (
        <ModalFormInputsLayout
            title={__("Delete organization text")}
            isModalOpen={isModalOpen}
            setIsModalOpen={setIsModalOpen}
            size="md"
            processing={processing}
            headerIcon="delete"
            saveText={__("Yes delete the organization text")}
