 ...
 */
export default function OpportunityDeleteModal({
    isModalOpen,
    setIsModalOpen,
    currentActionId,
}) {
    ...
    const deleteRoute = useMemo(
        () =>
            currentActionId
                ? route(routeNames.opportunityDelete, {
                      opportunity: currentActionId,
                      tenant,
                  })
                : null,
    ...
    return (
        <ModalFormInputsLayout
            title={__("Delete opportunity text")}
            isModalOpen={isModalOpen}
            setIsModalOpen={setIsModalOpen}
            size="md"
            processing={processing}
            headerIcon="delete"
            saveText={__("Yes delete the opportunity text")}
        ...
        >
            <ul className="list bg-base-100 rounded-box shadow-md divide-y divide-gray-200">
                ...
                <li className="py-2 px-1 text-[14px] font-semibold text-red-600 tracking-wide">
                    {__("Are you sure to delete this opportunity")}
                </li>
