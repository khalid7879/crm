...
export default function DataEmpSizeCreatePage() {
    ...
    const handleModelSubmit = (e) => {
        ...
        post(route(routeNames.dataEmpSizesStore, { tenant }), data, {
            preserveScroll: true,
            onSuccess: () => {
    ...
    return (
        <TenantSettingLayout metaTitle={metaTitle}>
            <Breadcrumb
                title={metaTitle}
                btnIcon="list"
                navItems={[...DataEmpSizeListNavItems, { name: "Create" }]}
