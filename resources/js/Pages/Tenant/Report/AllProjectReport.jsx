...
export default function AllProjectReport() {
    const {
        tenant,
        routeNames,
        reportData = {},
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await axios.get(
                route(routeNames.allProjectReportData, { tenant }),
                {
                    params: data,
                }
            );
    ...
    return (
        <TenantReportLayout metaTitle={__("Project")}>
            <TableCardComponent>
                {/* Filter */}
                <FilterFormComponent
                    data={data}
                    ...
                    resetLink={routeNames.allProjectReport}
                />
                <ButtonComponent
                    icon="filter"
                    text="Advance filter"
