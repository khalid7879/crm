...
export default function AllOrganizationReport() {
    const {
        tenant,
        routeNames,
        reportData = {},
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await axios.get(
                route(routeNames.allOrganizationReportData, { tenant }),
                {
                    params: data,
                }
            );
    ...
    return (
        <TenantReportLayout metaTitle={__("Organization")}>
            <TableCardComponent>
                {/* Filter */}
                <FilterFormComponent
                    data={data}
                    ...
                    resetLink={routeNames.allOrganizationReport}
                />
                <ButtonComponent
                    icon="filter"
                    text="Advance filter"
