...
export default function AllUserOwnerAssociateReport() {
    const {
        tenant,
        routeNames,
        reportData = {},
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await axios.get(
                route(routeNames.userOwnerAssociateReportData, { tenant }),
                {
                    params: data,
                }
            );
    ...
    return (
        <TenantReportLayout metaTitle={__("User Owner Associate")}>
            <TableCardComponent>
                {/* Filter */}
                <FilterFormComponent
                    data={data}
                    ...
                    resetLink={routeNames.userOwnerAssociateReport}
                />
                <ButtonComponent
                    icon="filter"
                    text="Advance filter"
            ...
            {isModalOpenAdvanceFilter && (
                <AdvanceFilterModal
                    ...
                    reportType="USER_OWNER_ASSOCIATE"
                />
            )}
        </TenantReportLayout>
    );
