...
export default function AllUserActivityLogReport() {
    const {
        tenant,
        routeNames,
        reportData = {},
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await axios.get(
                route(routeNames.userActivityLogReportData, { tenant }),
                {
                    params: data,
                }
            );
    ...
    return (
        <TenantReportLayout metaTitle={__("Contact")}>
            <TableCardComponent>
                {/* Filter */}
                <FilterFormComponent
                    data={data}
                    ...
                    resetLink={routeNames.userActivityLogReport}
                />
                <ButtonComponent
                    icon="filter"
                    text="Advance filter"
