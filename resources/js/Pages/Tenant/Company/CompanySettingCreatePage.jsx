...
import { TenantCompanySettingCreateInputs } from "@/utils/forms/companySettingInputs";
...
export default function CompanySettingCreatePage() {
    ...
    return (
        <TenantSettingLayout metaTitle={metaTitle}>
            <Breadcrumb
                title={metaTitle}
                btnIcon="list"
                navItems={[...CompanySettingNavItems, { name: "Create" }]}
            ...
            <TableCardComponent>
                ...
                >
                    {/* Single Input Field */}
                    {TenantCompanySettingCreateInputs.map((field) => (
